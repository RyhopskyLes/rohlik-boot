...
@EnableJpaRepositories(
                basePackages = {"com.rohlik.data.repos"})
@ComponentScan(basePackages = {"com.rohlik.data.entities","com.rohlik.data.services"})
public class TestAppConfig {
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factoryBean.setPackagesToScan("com.rohlik.data.entities");
